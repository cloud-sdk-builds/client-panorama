...
[`@aws-sdk/client-panorama`](https://www.npmjs.com/package/@aws-sdk/client-panorama/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LJy55sueIByB5AxKlaRNdosm2Ffb9Ln9r8KYyNulmBgLsJoFkSgucQahu0PBCkDp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-panorama": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.954.0/index.min.mjs": "sha384-LJy55sueIByB5AxKlaRNdosm2Ffb9Ln9r8KYyNulmBgLsJoFkSgucQahu0PBCkDp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-panorama/blob/refs/tags/3.954.0/LICENSE
```
