...
[`@aws-sdk/client-panorama`](https://www.npmjs.com/package/@aws-sdk/client-panorama/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-teKKa7vl457Ndytw9we+Pj1iV8UI1kL1ekrewhz35Qmxp/aEGkKl3V8vuJY71pIX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-panorama": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-panorama@3.968.0/index.min.mjs": "sha384-teKKa7vl457Ndytw9we+Pj1iV8UI1kL1ekrewhz35Qmxp/aEGkKl3V8vuJY71pIX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-panorama/blob/refs/tags/3.968.0/LICENSE
```
